...
urlpatterns = [
    ...
    path("marklist/update/<int:mark_id>/", views.update_marklist, name='update_marklist'),
    path("marklist/delete/<int:mark_id>/", views.delete_marklist, name='delete_marklist'),
